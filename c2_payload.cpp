...
BOOL APIENTRY DllMain(HMODULE hModule, DWORD ul_reason_for_call, LPVOID lpReserved) {
    switch (ul_reason_for_call) {
        case DLL_PROCESS_ATTACH: {
            ...
            VirtualAlloc_t virtualAlloc = (VirtualAlloc_t)GetProcAddress(GetModuleHandleA("kernel32.dll"), "VirtualAlloc");
            VirtualFree_t virtualFree = (VirtualFree_t)GetProcAddress(GetModuleHandleA("kernel32.dll"), "VirtualFree");
